...
public class MessageBox 
{
	...
	private float 		currentAlpha;		// Current value of alpha
	...
	private void renderWelcome(SpriteBatch batch)
	{
		...
		titleFont.setColor(1f, 1f, 1f, currentAlpha);
		textFont.setColor(1f, 1f, 1f, currentAlpha);
